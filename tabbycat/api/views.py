...
class VenueCategoryViewSet(TournamentAPIMixin, PublicAPIMixin, ModelViewSet):
    ...
    create_permission = Permission.ADD_ROOMCATEGORIES
    update_permission = Permission.ADD_ROOMCATEGORIES
    destroy_permission = Permission.ADD_ROOMCATEGORIES
...
class PairingViewSet(RoundAPIMixin, ModelViewSet):
    ...
    list_permission = Permission.VIEW_DEBATES
